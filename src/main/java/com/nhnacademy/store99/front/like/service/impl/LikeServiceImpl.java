...
public class LikeServiceImpl implements LikeService {
    ...
    @Override
    public CustomPageImpl<BookInfoForLikeResponse> getAllByUser(Pageable pageable, Long userId) {
        return Objects.requireNonNull(likeAdapter.findAllByUser(pageable, userId)).getResult();
    }
}